...
int main() {
    ...
    int idx_read = 190;
    rhs_hA->read_from_file("../../bimol_train/data_learned_visible/diff_eq_rhs/hA_"+pad_str(idx_read,4)+".txt");
    rhs_jAA->read_from_file("../../bimol_train/data_learned_visible/diff_eq_rhs/jAA_"+pad_str(idx_read,4)+".txt");
    rhs_kAAA->read_from_file("../../bimol_train/data_learned_visible/diff_eq_rhs/kAAA_"+pad_str(idx_read,4)+".txt");
    ...
    for (int IC=1; IC<=50; IC++) {
        ...
        auto init_cond_vector = read_init_conds("../../bimol_test_stoch_sim/data/ic_v"+pad_str(IC,3)+"/init_visible.txt");
